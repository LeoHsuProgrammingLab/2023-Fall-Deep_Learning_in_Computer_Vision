...
class CLIPScore:
    ...
    def __call__(self, predictions, images_root):
        ...
        """
        max_score = 0
        max_cap, max_fname = None, None
        min_score = 1
        min_cap, min_fname = None, None
        total_score = 0.
        ...
        for img_name, pred_caption in predictions.items():
            ...
            if score > max_score:
                max_score = score
                max_cap = pred_caption
                max_fname = img_name

            if score < min_score:
                min_score = score
                min_cap = pred_caption
                min_fname = img_name

            total_score += score

        print('max', max_score, max_fname, max_cap)
        print('min', min_score, min_fname, min_cap)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--images_root", default="/home/leohsu-cs/DLCV2023/hw3/hw3_data/p2_data/images/val", help="Image root")
    parser.add_argument("--annotation_file", default="/home/leohsu-cs/DLCV2023/hw3/hw3_data/p2_data/val.json", help="Annotation json file")
